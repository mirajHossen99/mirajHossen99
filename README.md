...
**Database**: MongoDB (Mongoose), Redis, Firestore, MySQL, PostgreSQL\
**Infrastructure**: Docker, RabbitMQ, KONG API Gateway, Firebase, Supabase\
**Workflow**: Git, GitHub, Postman, Jira, VS Code
...
[![My Portfolio](https://img.shields.io/badge/View_My_Portfolio-22C55E?style=for-the-badge&logo=vercel&logoColor=white)](https://miraj-hossen-portfolio.vercel.app/)
